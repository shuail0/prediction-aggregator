<!-- 源: https://docs.polymarket.com/quickstart/introduction/definitions -->
...
[Your First Order](/quickstart/orders/first-order)[API Rate Limits](/quickstart/introduction/rate-limits)
