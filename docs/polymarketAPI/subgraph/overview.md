<!-- 源: https://docs.polymarket.com/developers/subgraph/overview -->
...
[Get supported assets](/api-reference/bridge/get-supported-assets)[Resolution](/developers/resolution/UMA)
